...
def read_data(dataset, idx, is_train=True):
    if is_train:
        ...
        test_data_dir = os.path.join('data', dataset, 'global_test/')

        test_file = test_data_dir + str(0) + '.npz'
...
def read_client_public_data(dataset):
    public_data = read_public_data(dataset)
...
def read_public_data(dataset):
    public_data_dir = os.path.join('data', dataset, 'public/')
    public_file = os.path.join(public_data_dir, 'public_dataset.npz')
