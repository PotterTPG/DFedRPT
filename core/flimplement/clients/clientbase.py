...
class Client(object):
    ...
    def __init__(self, args, id, train_samples, test_samples, **kwargs):
        ...
        # --------FedNH----------
        self.momentum = args.sgd_momentum
        self.weight_decay = args.sgd_weight_decay
    ...
    def record_local_classes(self):
        train_data = read_client_data(self.dataset, self.id, is_train=True)
        unique_labels = set()
        for _, label_tensor in train_data:
            label = label_tensor.item()
            unique_labels.add(label)
        self.local_classes = unique_labels
