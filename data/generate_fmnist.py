...
num_clients = 10
num_classes = 10
dir_path = "fmnistPairwise_dir_0.5/"
...
def generate_fmnist(dir_path, num_clients, num_classes, niid, balance, partition):
    ...
    class_indices = {i: np.where(dataset_label_train == i)[0] for i in range(num_classes)}
    ...
    X, y, statistic, noise_ratios_dict,noisy_sample_indices_dict  = separate_data((dataset_image_train_remaining, dataset_label_train_remaining),
                                                       num_clients, num_classes,
                                                       niid, balance, partition, class_per_client=5, add_noise=True,
                                                       add_noise_type='pairflip')
