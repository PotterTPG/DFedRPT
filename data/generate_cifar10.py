...
num_clients = 10
num_classes = 10
dir_path = "Cifar10Pairwise_dir_0.5/"


# Allocate data to users
def generate_cifar10(dir_path, num_clients, num_classes, niid, balance, partition, samples_per_class=200):
    ...
    for i in range(num_classes):
        ...
        # 获取该类别的前 num_class_split_samples 个样本
    ...
    X, y, statistic,noise_ratios_dict,noisy_sample_indices_dict = separate_data((dataset_image_train_remaining, dataset_label_train_remaining), num_clients, num_classes,
                                    niid, balance, partition, class_per_client=5,add_noise=True,add_noise_type='pairflip')
